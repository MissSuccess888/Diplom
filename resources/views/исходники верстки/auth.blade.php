...
<body>
	...
	<section class="navbar navbar-default navbar-fixed-top" role="navigation">
		<!-- @auth
				<h6 style="float:right; margin-right:5%; bottom:0px; font: size 12px;">Вы авторизованы под  логином {{ $name }}</h6><br>
    @endauth -->
		<div class="container">
			...
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav navbar-right">
					...
					<!-- вместо @include('feedback.navauth') -->
					@if (Route::has('login'))
				<li role="presentation" class="dropdown">
						...
						<ul class="dropdown-menu">
							@auth
										<li><a href="{{ url('/dashboard') }}">Личный кабинет {{ $name }}</a></li>
