...
@section('content')
  <!-- Main jumbotron for a primary marketing message or call to action -->
    <div class="jumbotron">
        <div class="container">
					<br>
            <h2  class="heading"><span style="color:#d60c00;">{{ Auth::user()-> name }}, </span>здесь собраны Ваши заявки на бронирование</h2>
					<br>
    ...
    border-bottom: 1px solid rgba(0,0,0,.125);
											...
											<a href="{{ route('bookingDelete', $idBooking = $el->id) }}" class="btn btn-danger" style="margin-bottom: 15px;">Удалить запись</a>
									</div>
                </div>
								<br><br>
						@endif
            @endforeach
<a href="{{ route('booking') }}" class="btn btn-default btn-lg btn-block">Забронировать</a>
<br>
@endsection
